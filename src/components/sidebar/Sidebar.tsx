...
const Sidebar = ({screenRender} : SidebarProps) => {
    ...
    return (
        <div className="flex justify-center items-center pl-5">
            <aside className="w-24 p-4 flex flex-col text-center bg-white bg-opacity-30 backdrop-blur items-center justify-center md:px-10 lg:p-24 h-full lg:h-[500px] rounded drop-shadow-lg text-zinc-800">
